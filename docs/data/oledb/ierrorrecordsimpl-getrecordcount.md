...
OLE DB のレコード オブジェクト内のレコード数を返します。  
...
#### パラメーター  
 *OLE DB Programmer's Reference*の [IErrorRecords::GetRecordCount](https://msdn.microsoft.com/en-us/library/ms722724.aspx) を参照してください。  
