---
title: "OLE DB プロバイダー テンプレートの操作 | Microsoft Docs"
ms.custom: ""
ms.date: "12/03/2016"
...
helpviewer_keywords: 
  ...
  - "OLE DB, プロバイダー テンプレート"
  - "リファレンス, OLE DB プロバイダー テンプレート"
  - "テンプレート, OLE DB プロバイダー"
...
OLE DB プロバイダー テンプレートの操作方法については、次のトピックを参照してください。  
...
-   [プロバイダーでのフリー スレッドのサポート](../Topic/Supporting%20Free%20Threading%20in%20Your%20Provider.md)  
  
-   [プロバイダーのテスト](../Topic/Testing%20Your%20Provider.md)  
