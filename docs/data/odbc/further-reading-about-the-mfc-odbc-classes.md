...
---
# MFC ODBC クラスに関する詳細情報
[!INCLUDE[vs2017banner](../../assembler/inline/includes/vs2017banner.md)]

ここで紹介した概念や技法の詳細については、次のトピックを参照してください。  
...
-   [&#91;スナップショット&#93;](../Topic/Snapshot.md)  
  
-   [SQL](../../data/odbc/sql.md)  
  
-   [トランザクション \(ODBC\)](../../data/odbc/transaction-odbc.md)  
  
 「[レコードセット \(ODBC\)](../../data/odbc/recordset-odbc.md)」から読み始めることをお勧めします。  
  
 『MFC リファレンス』の「[CDatabase クラス](../../mfc/reference/cdatabase-class.md)」、「[CRecordset クラス](../Topic/CRecordset%20Class.md)」、「[CRecordView クラス](../../mfc/reference/crecordview-class.md)」、「[CFieldExchange クラス](../../mfc/reference/cfieldexchange-class.md)」、および「[CDBException クラス](../../mfc/reference/cdbexception-class.md)」を参照してください。  
