...
## 解説  
 ...
 `atan` には、ストリーミング SIMD 拡張機能 \(SSE2\) を使用して実装されています。  SSE2 実装の使い方の詳細および制約については、「[\_set\_SSE2\_enable](../Topic/_set_SSE2_enable.md)」を参照してください。  
...
```  
  ...
  **5.000000 のアークタンジェント: 1.373401**  
**0.500000\/5.000000 のアークタンジェント: 0.099669**   
