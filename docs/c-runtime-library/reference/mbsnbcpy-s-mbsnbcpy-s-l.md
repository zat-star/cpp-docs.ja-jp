...
文字列の `n` バイトを他の文字列にコピーします。  [\_mbsnbcpy、\_mbsnbcpy\_l](../Topic/_mbsnbcpy,%20_mbsnbcpy_l.md) のこれらのバージョンは、「[CRT のセキュリティ機能](../Topic/Security%20Features%20in%20the%20CRT.md)」に説明されているように、セキュリティが強化されています。  
