...
'member' の XML コメントで、cref 属性 'invalid\_syntax' の構文が正しくありません。  
 ...
 ドキュメント コメント用タグに渡されるパラメーターのいずれかの構文が正しくありません。 詳細については、「[ドキュメント コメントとして推奨されるタグ](../Topic/Recommended%20Tags%20for%20Documentation%20Comments%20\(C%23%20Programming%20Guide\).md)」を参照してください。  
