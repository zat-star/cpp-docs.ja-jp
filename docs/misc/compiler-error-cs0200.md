...
プロパティまたはインデクサー 'property' は読み取り専用なので、割り当てることはできません  
 ...
 [property](../Topic/Using%20Properties%20\(C%23%20Programming%20Guide\).md) に値を代入しようとしましたが、property には set アクセサーはありません。 set アクセサーを追加してエラーを解決します。 詳細については、「[方法: 読み取り\/書き込みのプロパティの宣言と使用](../Topic/How%20to:%20Declare%20and%20Use%20Read%20Write%20Properties%20\(C%23%20Programming%20Guide\).md)」を参照してください。  
