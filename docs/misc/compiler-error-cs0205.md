...
抽象基本メンバーを呼び出すことはできません: 'method'  
 ...
 [abstract](../Topic/abstract%20\(C%23%20Reference\).md) メソッドは、メソッド本体がないので、呼び出すことはできません。 詳細については、「[抽象クラスとシール クラス、およびクラス メンバー](../Topic/Abstract%20and%20Sealed%20Classes%20and%20Class%20Members%20\(C%23%20Programming%20Guide\).md)」を参照してください。  
