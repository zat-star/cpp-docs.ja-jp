...
params パラメーターは 1 次元配列でなければなりません。  
 ...
 [params](../Topic/params%20\(C%23%20Reference\).md) キーワードを使用する場合は、1 次元配列のデータ型を指定する必要があります。 詳細については、「[メソッド](../Topic/Methods%20\(C%23%20Programming%20Guide\).md)」を参照してください。  
