...
params パラメーターは、仮パラメーター リストの最後のパラメーターでなければなりません。  
 ...
 [params](../Topic/params%20\(C%23%20Reference\).md) パラメーターは引数の数を可変にすることができますが、他のすべてのパラメーターの後に指定する必要があります。 詳細については、「[メソッド](../Topic/Methods%20\(C%23%20Programming%20Guide\).md)」を参照してください。  
