...
プロパティ アクセサーは既に定義されています。  
 ...
 [プロパティ](../Topic/Using%20Properties%20\(C%23%20Programming%20Guide\).md)を宣言する場合、そのアクセサー メソッドも宣言する必要があります。 ただし、プロパティは複数の `get` アクセサー メソッドまたは複数の `set` アクセサー メソッドを持つことはできません。  
