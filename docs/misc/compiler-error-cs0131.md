...
代入式の左辺には変数、プロパティ、またはインデクサーを指定してください。  
 ...
 このエラーを解決するには、すべての演算子が右辺にあり、左辺が変数、プロパティ、またはインデクサーのいずれかであることを確認します。 詳細については、「[ステートメント、式、および演算子](../Topic/Statements,%20Expressions,%20and%20Operators%20\(C%23%20Programming%20Guide\).md)」を参照してください。  
