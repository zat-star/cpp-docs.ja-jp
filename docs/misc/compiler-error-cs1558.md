...
'class' は適切なスタティック Main メソッドを含んでいません  
 ...
 [\/main](../Topic/-main%20\(C%23%20Compiler%20Options\).md) コンパイラ オプションで、**Main** メソッドを検索するクラスを指定しました。 しかし、[Main](../Topic/Main\(\)%20and%20Command-Line%20Arguments%20\(C%23%20Programming%20Guide\).md) メソッドが正しく定義されていません。  
