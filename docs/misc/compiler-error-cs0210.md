...
fixed または using ステートメントの宣言の中に、初期化子を指定してください。  
 ...
 [fixed ステートメント](../Topic/fixed%20Statement%20\(C%23%20Reference\).md)で変数を宣言し、初期化する必要があります。 詳細については、「[unsafe コードとポインター](../Topic/Unsafe%20Code%20and%20Pointers%20\(C%23%20Programming%20Guide\).md)」を参照してください。  
...
```  
 ...
 [using ステートメント](../Topic/using%20Statement%20\(C%23%20Reference\).md)に初期化子がないため、CS0210 も生成されます。  
