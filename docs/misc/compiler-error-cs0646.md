...
インデクサーを含む型に対して DefaultMember 属性を指定できません。  
 ...
 クラスまたはその他の型で **System.Reflection.DefaultMemberAttribute** を指定する場合は、インデクサーを含めることはできません。 詳細については、「[プロパティ](../Topic/Properties%20\(C%23%20Programming%20Guide\).md)」を参照してください。  
