 ...
 **\/nowarn** コンパイラ オプションまたは `#pragmas warning` を使用すると、この警告を無効にできます。詳細については、「[\/nowarn \(Suppress Specified Warnings\)](../Topic/-nowarn%20\(C%23%20Compiler%20Options\).md)」または「[\#pragma 警告](../Topic/%23pragma%20warning%20\(C%23%20Reference\).md)」を参照してください。  
