...
XML リテラル宣言が使用されている式内の場所が、[!INCLUDE[vbprvb](../Token/vbprvb_md.md)] コンパイラにとってあいまいです。 つまり、[!INCLUDE[vbprvb](../Token/vbprvb_md.md)] コンパイラでは、小なり記号 \(\<\) が、比較演算子と XML リテラルの開始のどちらを意図しているか判断できません。 次にコード例を示します。  
