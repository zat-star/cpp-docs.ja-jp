...
'event': イベントはデリゲート型でなければなりません。  
 ...
 event キーワードには、[デリゲート](../Topic/delegate%20\(C%23%20Reference\).md)型が必要です。 詳細については、[イベント](../Topic/Events%20\(C%23%20Programming%20Guide\).md) および [デリゲート](../Topic/Delegates%20\(C%23%20Programming%20Guide\).md) を参照してください。  
