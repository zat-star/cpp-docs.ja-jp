...
制約リストに [New Operator](../Topic/New%20Operator%20\(Visual%20Basic\).md) 制約と [Structure \(Visual Basic\)](http://msdn.microsoft.com/ja-jp/263ce115-ac36-4c05-8cb7-0e0eead5c6d0) 制約の両方が含まれています。  
