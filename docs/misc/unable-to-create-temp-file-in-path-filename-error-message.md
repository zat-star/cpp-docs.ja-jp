...
[!INCLUDE[vbprvb](../Token/vbprvb_md.md)] コンパイラはアセンブリ リンカー \(Al.exe、Alink とも呼ばれる\) を呼び出し、マニフェストを伴うアセンブリを生成します。 リンカーが、ファイルの作成またはインメモリ ソースの書き込みでエラーを報告しました。 構成の問題である可能性があります。  
