...
フィールド 'field' は、割り当てられていない可能性があります  
 ...
 構造内のフィールドが、最初に初期化しないで使用されています。 この問題を解決するには、初期化されていないフィールドをまず確認し、そのフィールドにアクセスする前に初期化します。 構造体の初期化に関する詳細については、「[構造体](../Topic/Structs%20\(C%23%20Programming%20Guide\).md)」、および「[構造体の使用](../Topic/Using%20Structs%20\(C%23%20Programming%20Guide\).md)」をご覧ください。  
