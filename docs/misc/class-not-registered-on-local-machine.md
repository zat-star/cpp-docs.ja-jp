---
title: "クラスがローカル コンピューターに登録されていません | Microsoft Docs"
ms.custom: ""
ms.date: "12/15/2016"
...
manager: "wpickett"
---
# クラスがローカル コンピューターに登録されていません
このエラーは通常、ファイルが破損している場合に発生します。[!INCLUDE[vsprvs](../assembler/masm/includes/vsprvs_md.md)] の再インストールが必要なことがあります。  
