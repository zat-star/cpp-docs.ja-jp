...
-   コクラスを含むアセンブリへの参照を追加します \(ほとんどの場合、インターフェイスとコクラスは同じアセンブリにあります\)。 詳細については、「[\/reference](../Topic/-reference%20\(C%23%20Compiler%20Options\).md)」または「[&#91;参照の追加&#93; ダイアログ ボックス](http://msdn.microsoft.com/ja-jp/2feb0fe2-0805-4cc9-8cba-b0315849dfb7)」を参照してください。  
