...
抽象クラスまたはインターフェイス 'interface' のインスタンスを作成できません  
 ...
 [抽象](../Topic/abstract%20\(C%23%20Reference\).md)クラスまたは[インターフェイス](../Topic/interface%20\(C%23%20Reference\).md) 'interface' のインスタンスを作成できません。 詳細については、「[インターフェイス](../Topic/Interfaces%20\(C%23%20Programming%20Guide\).md)」を参照してください。  
