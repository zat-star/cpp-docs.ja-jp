---
title: "swap (STL/CLR) |Microsoft ドキュメント"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
## <a name="remarks"></a>コメント  
 この関数の動作は、C++ 標準ライブラリ関数と同じ`swap`です。 詳細については、次を参照してください。[スワップ](http://msdn.microsoft.com/Library/b471a2de-035e-4aff-b1c7-345d85d93972)です。  
