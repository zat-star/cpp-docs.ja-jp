...
## 解説  
 このメンバー関数は `(float)`[hash\_set::size](../dotnet/hash-set-size-stl-clr.md)`() /`[hash\_set::bucket\_count](../dotnet/hash-set-bucket-count-stl-clr.md)`()`を返します。  平均バケットのサイズを決定するために使用します。  
