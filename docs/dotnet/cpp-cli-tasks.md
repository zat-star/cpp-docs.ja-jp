...
## <a name="in-this-section"></a>このセクションの内容  
 ...
 - [方法: クラスと構造体を定義および使用する (C++/CLI)](../dotnet/how-to-define-and-consume-classes-and-structs-cpp-cli.md)  
 ...
 - [方法: C++/CLI で列挙型を定義および使用する](../dotnet/how-to-define-and-consume-enums-in-cpp-cli.md)  
 - [方法: C++/CLI でイベントを使用する](../dotnet/how-to-use-events-in-cpp-cli.md)  
 - [方法: インターフェイス静的コンストラクターを定義する (C++/CLI)](../dotnet/how-to-define-an-interface-static-constructor-cpp-cli.md)  
 - [方法: ネイティブ コンパイルでオーバーライド指定子を宣言する (C++/CLI)](../dotnet/how-to-declare-override-specifiers-in-native-compilations-cpp-cli.md)  
