---
title: "remove_copy (STL/CLR) |Microsoft ドキュメント"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
## <a name="remarks"></a>コメント  
 この関数の動作は、C++ 標準ライブラリ関数と同じ`remove_copy`です。 詳細については、次を参照してください。 [remove_copy](../standard-library/algorithm-functions.md#remove_copy)です。  
