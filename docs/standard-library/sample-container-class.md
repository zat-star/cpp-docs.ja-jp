...
*すべて*次のメンバー関数への呼び出し中に例外がスローされた場合は、C++ 標準ライブラリで定義されているコンテナー クラス**挿入**、 **push_back**、または**push_front**コンテナーは変更されず、例外が再度スローされます。

*すべて*C++ 標準ライブラリで定義されているコンテナー クラス、例外はスローされず、次のメンバー関数への呼び出し中に: **pop_back**、 **pop_front**です。
