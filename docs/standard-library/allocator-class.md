...
*_Hint*アロケーター オブジェクトに役立つ可能性のある const ポインターが要求する前に割り当てられたオブジェクトのアドレスを探すことによって記憶域の要求を満たすため。
...
`right` このようなオブジェクト別に割り当てられるアロケーター オブジェクト。
