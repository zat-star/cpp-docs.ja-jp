---
title: "Y (プリコンパイル済みヘッダー) |Microsoft ドキュメント"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
-   [/Yd (デバッグ情報のオブジェクト ファイル) への取り込み](../../build/reference/yd-place-debug-information-in-object-file.md)  
...
-   [/Yu (プリコンパイル済みヘッダー ファイルの使用)](../../build/reference/yu-use-precompiled-header-file.md)  
 ...
 プリコンパイル済みヘッダーの使用の詳細については、「[プリコンパイル済みヘッダー ファイルの作成](../../build/reference/creating-precompiled-header-files.md)です。  
