...
次に示す Visual C++ のサンプルでは、複数のテクノロジの使用を含むさまざまな機能の例を示します。  
 ...
 [Windows ストア アプリのサンプル](http://code.msdn.microsoft.com/windowsapps/site/search?f%5B0%5D.Type=ProgrammingLanguage&f%5B0%5D.Value=C%2B%2B&f%5B0%5D.Text=C%2B%2B)  
 ...
 [ADO コードのサンプル](http://msdn.microsoft.com/library/windows/desktop/ms677563\(v=vs.85\).aspx)  
  
 [Windows ハードウェア開発のサンプル](http://code.msdn.microsoft.com/windowshardware/site/search?f%5B0%5D.Type=ProgrammingLanguage&f%5B0%5D.Value=C%2B%2B&f%5B0%5D.Text=C%2B%2B)  
