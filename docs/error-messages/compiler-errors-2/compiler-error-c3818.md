...
配列プロパティ宣言 'property1' はインデックスのプロパティ 'property2' をオーバー ロードしません。  
  
 オーバー ロードは、1 つは、インデクサーし、もう一方の配列プロパティとプロパティのことはできません。 
  
 C3818 は古いコンパイラ オプションを使用して到達のみ**/clr:oldSyntax**します。  
