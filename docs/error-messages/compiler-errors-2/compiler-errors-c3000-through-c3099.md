...
|[コンパイラ エラー C3055](compiler-error-c3055.md)|'*識別子*': 'threadprivate' ディレクティブで使用される前に、シンボルを参照することはできません|  
...
|コンパイラ エラー C3092|'*クラス*': 属性クラス メンバーがビット フィールド、'static' または 'const' にすることはできません|  
