...
|[コンパイラ エラー C2003](compiler-error-c2003.md)|予期された ' 定義 id'|
|[コンパイラ エラー C2004](compiler-error-c2004.md)|'defined (id)' の形式にしてください。|
|[コンパイラ エラー C2005](compiler-error-c2005.md)|#line 指定されている行番号、'*トークン*'|
...
|[コンパイラ エラー C2014](compiler-error-c2014.md)|最初の空白としてプリプロセッサ コマンドを起動する必要があります。|
|[コンパイラ エラー C2015](compiler-error-c2015.md)|定数の文字が多すぎます|
|コンパイラ エラー C2016|C は構造体または共用体に少なくとも 1 つのメンバー|
|[コンパイラ エラー C2017](compiler-error-c2017.md)|無効なエスケープ シーケンス|
