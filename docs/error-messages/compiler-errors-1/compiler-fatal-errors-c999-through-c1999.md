...
|エラー|メッセージ|  
|---------|-----------|  
|[Fatal Error C999](../../error-messages/compiler-errors-1/fatal-error-c999.md)|不明なメッセージ: 詳細については、Visual C\+\+ ヘルプ メニューのサポート情報コマンドを選択してください。またはサポート情報ヘルプ ファイルを参照してください。|  
...
|[致命的なエラー C1010](../../error-messages/compiler-errors-1/fatal-error-c1010.md)|プリコンパイル ヘッダーを検索中に不明な EOF が見つかりました。 '\#include \<`file`\>' をソースに追加することをお勧めします。|  
...
|[致命的なエラー C1061](../Topic/Fatal%20Error%20C1061.md)|コンパイラの制限: プログラム内のブロックの入れ子のレベルが深すぎます。|  
|致命的なエラー C1063|コンパイラの制限: コンパイラ スタックのオーバー フローが発生しました。|  
|[致命的なエラー C1064](../Topic/Fatal%20Error%20C1064.md)|コンパイラの制限: コンパイラが、識別子の名前用の内部バッファーよりも長い識別子を読み取りました。|  
|[致命的なエラー C1065](../Topic/Fatal%20Error%20C1065.md)|コンパイラの制限: タグが足りません。|  
...
|[致命的なエラー C1071](../Topic/Fatal%20Error%20C1071.md)|コメント内で予期しない EOF が見つかりました。|  
...
|[致命的なエラー C1076](../Topic/Fatal%20Error%20C1076.md)|コンパイラの制限: 内部ヒープの上限に達しました。上限を変更するには \/Zm オプションを使用してください。|  
...
|[致命的なエラー C1081](../Topic/Fatal%20Error%20C1081.md)|'`file`': ファイル名が長すぎます。|  
...
|[致命的なエラー C1085](../Topic/Fatal%20Error%20C1085.md)|`type` ファイルを書き込むことができません: '`file`': `message`|  
...
|[致命的なエラー C1107](../Topic/Fatal%20Error%20C1107.md)|アセンブリ '`assembly`' が見つかりませんでした: \/AI を使用するか LIBPATH 環境変数を設定してアセンブリ検索パスを指定してください。|  
...
|[致命的なエラー C1113](../Topic/Fatal%20Error%20C1113.md)|\#using が '`file`' で失敗しました。|  
...
|[致命的なエラー C1128](../Topic/Fatal%20Error%20C1128.md)|セクションの数がオブジェクト ファイル形式の制限を超えています: \/bigobj と共にコンパイルしてください|  
...
|[致命的なエラー C1308](../Topic/Fatal%20Error%20C1308.md)|`file`: リンク アセンブリはサポートされていません。|  
|[致命的なエラー C1309](../Topic/Fatal%20Error%20C1309.md)|C2.DLL および pgodb`ver`.DLL のバージョンが一致しません。|  
...
|致命的なエラー C1384|PGO\_PATH\_TRANSLATION の設定が正しくないため '`file`' とリンクできません。|  
|致命的なエラー C1451|concurrency::parallel\_for\_each の呼び出し先をコンパイルするときにデバッグ情報を生成できませんでした \(concurrency::parallel\_for\_each の位置: '`callsite`'\)|  
...
|致命的なエラー C1510|言語リソース clui.dll を開くことができません|  
|[致命的なエラー C1600](../Topic/Fatal%20Error%20C1600.md)|サポートされていないデータ型|  
|[致命的なエラー C1601](../Topic/Fatal%20Error%20C1601.md)|サポートされていないインライン アセンブラー オペコード|  
...
|[致命的なエラー C1853](../Topic/Fatal%20Error%20C1853.md)|'`file`' プリコンパイル ヘッダー ファイルが旧バージョンのコンパイラで作成されています。また、C\+\+ のプリコンパイル済みヘッダー ファイルを C で使用しています \(その逆も考えられます\)。|  
