...
---
# コンパイラの警告 (レベル 1) C4947
[!INCLUDE[vs2017banner](../../assembler/inline/includes/vs2017banner.md)]

'type\_or\_member': obsolete としてマークされています  
  
 メンバーまたは型が、[ObsoleteAttribute](frlrfSystemObsoleteAttributeClassTopic) クラスで obsolete としてマークされています。  
