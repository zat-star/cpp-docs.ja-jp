---
title: "コンパイラの警告 (レベル 4) C4754 |Microsoft ドキュメント"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
比較での算術演算の変換規則により、いずれかの分岐を実行できません。  
 ...
 整数変換の規則は複雑であり、気付きにくい落とし穴が数多くあります。 C4754 警告を修正する代わりに、使用するコードを更新することができます、 [SafeInt ライブラリ](../../windows/safeint-library.md)です。  
