---
title: "omp_nest_lock_t |Microsoft ドキュメント"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
ロックに関する情報の次の情報を保持する型: かどうか、ロックが使用できる、およびロックが解除され、入れ子のカウントを所有するスレッドの id。  
...
## <a name="example"></a>例  
 参照してください[omp_init_nest_lock](../../../parallel/openmp/reference/omp-init-nest-lock.md)を使用する例については**omp_nest_lock_t**します。  
