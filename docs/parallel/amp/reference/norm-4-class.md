---
title: "norm_4 クラス |Microsoft ドキュメント"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
|norm_4::get_wx メソッド||  
|norm_4::get_wxy メソッド||  
|norm_4::get_wxyz メソッド||  
|norm_4::get_wxz メソッド||  
|norm_4::get_wxzy メソッド||  
|norm_4::get_wy メソッド||  
|norm_4::get_wyx メソッド||  
|norm_4::get_wyxz メソッド||  
|norm_4::get_wyz メソッド||  
|norm_4::get_wyzx メソッド||  
|norm_4::get_wz メソッド||  
|norm_4::get_wzx メソッド||  
|norm_4::get_wzxy メソッド||  
|norm_4::get_wzy メソッド||  
|norm_4::get_wzyx メソッド||  
|norm_4::get_x メソッド||  
|norm_4::get_xw メソッド||  
|norm_4::get_xwy メソッド||  
|norm_4::get_xwyz メソッド||  
|norm_4::get_xwz メソッド||  
|norm_4::get_xwzy メソッド||  
|norm_4::get_xy メソッド||  
|norm_4::get_xyw メソッド||  
|norm_4::get_xywz メソッド||  
|norm_4::get_xyz メソッド||  
|norm_4::get_xyzw メソッド||  
|norm_4::get_xz メソッド||  
|norm_4::get_xzw メソッド||  
|norm_4::get_xzwy メソッド||  
|norm_4::get_xzy メソッド||  
|norm_4::get_xzyw メソッド||  
|norm_4::get_y メソッド||  
|norm_4::get_yw メソッド||  
|norm_4::get_ywx メソッド||  
|norm_4::get_ywxz メソッド||  
|norm_4::get_ywz メソッド||  
|norm_4::get_ywzx メソッド||  
|norm_4::get_yx メソッド||  
|norm_4::get_yxw メソッド||  
|norm_4::get_yxwz メソッド||  
|norm_4::get_yxz メソッド||  
|norm_4::get_yxzw メソッド||  
|norm_4::get_yz メソッド||  
|norm_4::get_yzw メソッド||  
|norm_4::get_yzwx メソッド||  
|norm_4::get_yzx メソッド||  
|norm_4::get_yzxw メソッド||  
|norm_4::get_z メソッド||  
|norm_4::get_zw メソッド||  
|norm_4::get_zwx メソッド||  
|norm_4::get_zwxy メソッド||  
|norm_4::get_zwy メソッド||  
|norm_4::get_zwyx メソッド||  
|norm_4::get_zx メソッド||  
|norm_4::get_zxw メソッド||  
|norm_4::get_zxwy メソッド||  
|norm_4::get_zxy メソッド||  
|norm_4::get_zxyw メソッド||  
|norm_4::get_zy メソッド||  
|norm_4::get_zyw メソッド||  
|norm_4::get_zywx メソッド||  
|norm_4::get_zyx メソッド||  
|norm_4::get_zyxw メソッド||  
|norm_4::ref_a メソッド||  
|norm_4::ref_b メソッド||  
|norm_4::ref_g メソッド||  
|norm_4::ref_r メソッド||  
...
|norm_4::set_wx メソッド||  
|norm_4::set_wxy メソッド||  
|norm_4::set_wxyz メソッド||  
|norm_4::set_wxz メソッド||  
|norm_4::set_wxzy メソッド||  
|norm_4::set_wy メソッド||  
|norm_4::set_wyx メソッド||  
|norm_4::set_wyxz メソッド||  
|norm_4::set_wyz メソッド||  
|norm_4::set_wyzx メソッド||  
|norm_4::set_wz メソッド||  
|norm_4::set_wzx メソッド||  
|norm_4::set_wzxy メソッド||  
|norm_4::set_wzy メソッド||  
|norm_4::set_wzyx メソッド||  
|norm_4::set_x メソッド||  
|norm_4::set_xw メソッド||  
|norm_4::set_xwy メソッド||  
|norm_4::set_xwyz メソッド||  
|norm_4::set_xwz メソッド||  
|norm_4::set_xwzy メソッド||  
|norm_4::set_xy メソッド||  
|norm_4::set_xyw メソッド||  
|norm_4::set_xywz メソッド||  
|norm_4::set_xyz メソッド||  
|norm_4::set_xyzw メソッド||  
|norm_4::set_xz メソッド||  
|norm_4::set_xzw メソッド||  
|norm_4::set_xzwy メソッド||  
|norm_4::set_xzy メソッド||  
|norm_4::set_xzyw メソッド||  
|norm_4::set_y メソッド||  
|norm_4::set_yw メソッド||  
|norm_4::set_ywx メソッド||  
|norm_4::set_ywxz メソッド||  
|norm_4::set_ywz メソッド||  
|norm_4::set_ywzx メソッド||  
|norm_4::set_yx メソッド||  
|norm_4::set_yxw メソッド||  
|norm_4::set_yxwz メソッド||  
|norm_4::set_yxz メソッド||  
|norm_4::set_yxzw メソッド||  
|norm_4::set_yz メソッド||  
|norm_4::set_yzw メソッド||  
|norm_4::set_yzwx メソッド||  
|norm_4::set_yzx メソッド||  
|norm_4::set_yzxw メソッド||  
|norm_4::set_z メソッド||  
|norm_4::set_zw メソッド||  
|norm_4::set_zwx メソッド||  
|norm_4::set_zwxy メソッド||  
|norm_4::set_zwy メソッド||  
|norm_4::set_zwyx メソッド||  
|norm_4::set_zx メソッド||  
|norm_4::set_zxw メソッド||  
|norm_4::set_zxwy メソッド||  
|norm_4::set_zxy メソッド||  
|norm_4::set_zxyw メソッド||  
|norm_4::set_zy メソッド||  
|norm_4::set_zyw メソッド||  
|norm_4::set_zywx メソッド||  
|norm_4::set_zyx メソッド||  
|norm_4::set_zyxw メソッド||  
...
|norm_4::ab データ メンバー||  
|norm_4::abg データ メンバー||  
|norm_4::abgr データ メンバー||  
|norm_4::abr データ メンバー||  
|norm_4::abrg データ メンバー||  
|norm_4::ag データ メンバー||  
|norm_4::agb データ メンバー||  
|norm_4::agbr データ メンバー||  
|norm_4::agr データ メンバー||  
|norm_4::agrb データ メンバー||  
|norm_4::ar データ メンバー||  
|norm_4::arb データ メンバー||  
|norm_4::arbg データ メンバー||  
|norm_4::arg データ メンバー||  
|norm_4::argb データ メンバー||  
|norm_4::b データ メンバー||  
|norm_4::ba データ メンバー||  
|norm_4::bag データ メンバー||  
|norm_4::bagr データ メンバー||  
|norm_4::bar データ メンバー||  
|norm_4::barg データ メンバー||  
|norm_4::bg データ メンバー||  
|norm_4::bga データ メンバー||  
|norm_4::bgar データ メンバー||  
|norm_4::bgr データ メンバー||  
|norm_4::bgra データ メンバー||  
|norm_4::br データ メンバー||  
|norm_4::bra データ メンバー||  
|norm_4::brag データ メンバー||  
|norm_4::brg データ メンバー||  
|norm_4::brga データ メンバー||  
|norm_4::g データ メンバー||  
|norm_4::ga データ メンバー||  
|norm_4::gab データ メンバー||  
|norm_4::gabr データ メンバー||  
|norm_4::gar データ メンバー||  
|norm_4::garb データ メンバー||  
|norm_4::gb データ メンバー||  
|norm_4::gba データ メンバー||  
|norm_4::gbar データ メンバー||  
|norm_4::gbr データ メンバー||  
|norm_4::gbra データ メンバー||  
|norm_4::gr データ メンバー||  
|norm_4::gra データ メンバー||  
|norm_4::grab データ メンバー||  
|norm_4::grb データ メンバー||  
|norm_4::grba データ メンバー||  
|norm_4::r データ メンバー||  
|norm_4::ra データ メンバー||  
|norm_4::rab データ メンバー||  
|norm_4::rabg データ メンバー||  
|norm_4::rag データ メンバー||  
|norm_4::ragb データ メンバー||  
|norm_4::rb データ メンバー||  
|norm_4::rba データ メンバー||  
|norm_4::rbag データ メンバー||  
|norm_4::rbg データ メンバー||  
|norm_4::rbga データ メンバー||  
|norm_4::rg データ メンバー||  
|norm_4::rga データ メンバー||  
|norm_4::rgab データ メンバー||  
|norm_4::rgb データ メンバー||  
|norm_4::rgba データ メンバー||  
|norm_4::w データ メンバー||  
|norm_4::wx データ メンバー||  
|norm_4::wxy データ メンバー||  
|norm_4::wxyz データ メンバー||  
|norm_4::wxz データ メンバー||  
|norm_4::wxzy データ メンバー||  
|norm_4::wy データ メンバー||  
|norm_4::wyx データ メンバー||  
|norm_4::wyxz データ メンバー||  
|norm_4::wyz データ メンバー||  
|norm_4::wyzx データ メンバー||  
|norm_4::wz データ メンバー||  
|norm_4::wzx データ メンバー||  
|norm_4::wzxy データ メンバー||  
|norm_4::wzy データ メンバー||  
|norm_4::wzyx データ メンバー||  
|norm_4::x データ メンバー||  
|norm_4::xw データ メンバー||  
|norm_4::xwy データ メンバー||  
|norm_4::xwyz データ メンバー||  
|norm_4::xwz データ メンバー||  
|norm_4::xwzy データ メンバー||  
|norm_4::xy データ メンバー||  
|norm_4::xyw データ メンバー||  
|norm_4::xywz データ メンバー||  
|norm_4::xyz データ メンバー||  
|norm_4::xyzw データ メンバー||  
|norm_4::xz データ メンバー||  
|norm_4::xzw データ メンバー||  
|norm_4::xzwy データ メンバー||  
|norm_4::xzy データ メンバー||  
|norm_4::xzyw データ メンバー||  
|norm_4::y データ メンバー||  
|norm_4::yw データ メンバー||  
|norm_4::ywx データ メンバー||  
|norm_4::ywxz データ メンバー||  
|norm_4::ywz データ メンバー||  
|norm_4::ywzx データ メンバー||  
|norm_4::yx データ メンバー||  
|norm_4::yxw データ メンバー||  
|norm_4::yxwz データ メンバー||  
|norm_4::yxz データ メンバー||  
|norm_4::yxzw データ メンバー||  
|norm_4::yz データ メンバー||  
|norm_4::yzw データ メンバー||  
|norm_4::yzwx データ メンバー||  
|norm_4::yzx データ メンバー||  
|norm_4::yzxw データ メンバー||  
|norm_4::z データ メンバー||  
|norm_4::zw データ メンバー||  
|norm_4::zwx データ メンバー||  
|norm_4::zwxy データ メンバー||  
|norm_4::zwy データ メンバー||  
|norm_4::zwyx データ メンバー||  
|norm_4::zx データ メンバー||  
|norm_4::zxw データ メンバー||  
|norm_4::zxwy データ メンバー||  
|norm_4::zxy データ メンバー||  
|norm_4::zxyw データ メンバー||  
|norm_4::zy データ メンバー||  
|norm_4::zyw データ メンバー||  
|norm_4::zywx データ メンバー||  
|norm_4::zyx データ メンバー||  
|norm_4::zyxw データ メンバー||  
...
##  <a name="a-namenorm4sizea-size"></a><a name="norm_4__size"></a>サイズ 
