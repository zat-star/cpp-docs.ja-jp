---
title: "unorm_4 クラス | Microsoft Docs"
ms.custom: ""
ms.date: "11/04/2016"
ms.reviewer: ""
ms.suite: ""
...
|名前|説明|  
|--------|--------|  
|[unorm\_4::unorm\_4 コンストラクター](../Topic/unorm_4::unorm_4%20Constructor.md)|オーバーロードされます。  既定のコンストラクター。すべての要素を 0 で初期化します。|  
  
### パブリック メソッド  
  
|名前|説明|  
|--------|--------|  
|unorm\_4::get\_w メソッド||  
|unorm\_4::get\_wx メソッド||  
|unorm\_4::get\_wxy メソッド||  
|unorm\_4::get\_wxyz メソッド||  
|unorm\_4::get\_wxz メソッド||  
|unorm\_4::get\_wxzy メソッド||  
|unorm\_4::get\_wy メソッド||  
|unorm\_4::get\_wyx メソッド||  
|unorm\_4::get\_wyxz メソッド||  
|unorm\_4::get\_wyz メソッド||  
|unorm\_4::get\_wyzx メソッド||  
|unorm\_4::get\_wz メソッド||  
|unorm\_4::get\_wzx メソッド||  
|unorm\_4::get\_wzxy メソッド||  
|unorm\_4::get\_wzy メソッド||  
|unorm\_4::get\_wzyx メソッド||  
|unorm\_4::get\_x メソッド||  
|unorm\_4::get\_xw メソッド||  
|unorm\_4::get\_xwy メソッド||  
|unorm\_4::get\_xwyz メソッド||  
|unorm\_4::get\_xwz メソッド||  
|unorm\_4::get\_xwzy メソッド||  
|unorm\_4::get\_xy メソッド||  
|unorm\_4::get\_xyw メソッド||  
|unorm\_4::get\_xywz メソッド||  
|unorm\_4::get\_xyz メソッド||  
|unorm\_4::get\_xyzw メソッド||  
|unorm\_4::get\_xz メソッド||  
|unorm\_4::get\_xzw メソッド||  
|unorm\_4::get\_xzwy メソッド||  
|unorm\_4::get\_xzy メソッド||  
|unorm\_4::get\_xzyw メソッド||  
|unorm\_4::get\_y メソッド||  
|unorm\_4::get\_yw メソッド||  
|unorm\_4::get\_ywx メソッド||  
|unorm\_4::get\_ywxz メソッド||  
|unorm\_4::get\_ywz メソッド||  
|unorm\_4::get\_ywzx メソッド||  
|unorm\_4::get\_yx メソッド||  
|unorm\_4::get\_yxw メソッド||  
|unorm\_4::get\_yxwz メソッド||  
|unorm\_4::get\_yxz メソッド||  
|unorm\_4::get\_yxzw メソッド||  
|unorm\_4::get\_yz メソッド||  
|unorm\_4::get\_yzw メソッド||  
|unorm\_4::get\_yzwx メソッド||  
|unorm\_4::get\_yzx メソッド||  
|unorm\_4::get\_yzxw メソッド||  
|unorm\_4::get\_z メソッド||  
|unorm\_4::get\_zw メソッド||  
|unorm\_4::get\_zwx メソッド||  
|unorm\_4::get\_zwxy メソッド||  
|unorm\_4::get\_zwy メソッド||  
|unorm\_4::get\_zwyx メソッド||  
|unorm\_4::get\_zx メソッド||  
|unorm\_4::get\_zxw メソッド||  
|unorm\_4::get\_zxwy メソッド||  
|unorm\_4::get\_zxy メソッド||  
|unorm\_4::get\_zxyw メソッド||  
|unorm\_4::get\_zy メソッド||  
|unorm\_4::get\_zyw メソッド||  
|unorm\_4::get\_zywx メソッド||  
|unorm\_4::get\_zyx メソッド||  
|unorm\_4::get\_zyxw メソッド||  
|unorm\_4::ref\_a メソッド||  
|unorm\_4::ref\_b メソッド||  
|unorm\_4::ref\_g メソッド||  
|unorm\_4::ref\_r メソッド||  
|unorm\_4::ref\_w メソッド||  
|unorm\_4::ref\_x メソッド||  
|unorm\_4::ref\_y メソッド||  
|unorm\_4::ref\_z メソッド||  
|unorm\_4::set\_w メソッド||  
|unorm\_4::set\_wx メソッド||  
|unorm\_4::set\_wxy メソッド||  
|unorm\_4::set\_wxyz メソッド||  
|unorm\_4::set\_wxz メソッド||  
|unorm\_4::set\_wxzy メソッド||  
|unorm\_4::set\_wy メソッド||  
|unorm\_4::set\_wyx メソッド||  
|unorm\_4::set\_wyxz メソッド||  
|unorm\_4::set\_wyz メソッド||  
|unorm\_4::set\_wyzx メソッド||  
|unorm\_4::set\_wz メソッド||  
|unorm\_4::set\_wzx メソッド||  
|unorm\_4::set\_wzxy メソッド||  
|unorm\_4::set\_wzy メソッド||  
|unorm\_4::set\_wzyx メソッド||  
|unorm\_4::set\_x メソッド||  
|unorm\_4::set\_xw メソッド||  
|unorm\_4::set\_xwy メソッド||  
|unorm\_4::set\_xwyz メソッド||  
|unorm\_4::set\_xwz メソッド||  
|unorm\_4::set\_xwzy メソッド||  
|unorm\_4::set\_xy メソッド||  
|unorm\_4::set\_xyw メソッド||  
|unorm\_4::set\_xywz メソッド||  
|unorm\_4::set\_xyz メソッド||  
|unorm\_4::set\_xyzw メソッド||  
|unorm\_4::set\_xz メソッド||  
|unorm\_4::set\_xzw メソッド||  
|unorm\_4::set\_xzwy メソッド||  
|unorm\_4::set\_xzy メソッド||  
|unorm\_4::set\_xzyw メソッド||  
|unorm\_4::set\_y メソッド||  
|unorm\_4::set\_yw メソッド||  
|unorm\_4::set\_ywx メソッド||  
|unorm\_4::set\_ywxz メソッド||  
|unorm\_4::set\_ywz メソッド||  
|unorm\_4::set\_ywzx メソッド||  
|unorm\_4::set\_yx メソッド||  
|unorm\_4::set\_yxw メソッド||  
|unorm\_4::set\_yxwz メソッド||  
|unorm\_4::set\_yxz メソッド||  
|unorm\_4::set\_yxzw メソッド||  
|unorm\_4::set\_yz メソッド||  
|unorm\_4::set\_yzw メソッド||  
|unorm\_4::set\_yzwx メソッド||  
|unorm\_4::set\_yzx メソッド||  
|unorm\_4::set\_yzxw メソッド||  
|unorm\_4::set\_z メソッド||  
|unorm\_4::set\_zw メソッド||  
|unorm\_4::set\_zwx メソッド||  
|unorm\_4::set\_zwxy メソッド||  
|unorm\_4::set\_zwy メソッド||  
|unorm\_4::set\_zwyx メソッド||  
|unorm\_4::set\_zx メソッド||  
|unorm\_4::set\_zxw メソッド||  
|unorm\_4::set\_zxwy メソッド||  
|unorm\_4::set\_zxy メソッド||  
|unorm\_4::set\_zxyw メソッド||  
|unorm\_4::set\_zy メソッド||  
|unorm\_4::set\_zyw メソッド||  
|unorm\_4::set\_zywx メソッド||  
|unorm\_4::set\_zyx メソッド||  
|unorm\_4::set\_zyxw メソッド||  
  
### パブリック演算子  
  
|名前|説明|  
|--------|--------|  
|unorm\_4::operator\- 演算子||  
|unorm\_4::operator\-\- 演算子||  
|unorm\_4::operator\*\= 演算子||  
|unorm\_4::operator\/\= 演算子||  
|unorm\_4::operator\+\+ 演算子||  
...
|名前|説明|  
|--------|--------|  
|[unorm\_4::size 定数](../Topic/unorm_4::size%20Constant.md)||  
...
|--------|--------|  
|unorm\_4::a データ メンバー||  
|unorm\_4::ab データ メンバー||  
|unorm\_4::abg データ メンバー||  
|unorm\_4::abgr データ メンバー||  
|unorm\_4::abr データ メンバー||  
|unorm\_4::abrg データ メンバー||  
|unorm\_4::ag データ メンバー||  
|unorm\_4::agb データ メンバー||  
|unorm\_4::agbr データ メンバー||  
|unorm\_4::agr データ メンバー||  
|unorm\_4::agrb データ メンバー||  
|unorm\_4::ar データ メンバー||  
|unorm\_4::arb データ メンバー||  
|unorm\_4::arbg データ メンバー||  
|unorm\_4::arg データ メンバー||  
|unorm\_4::argb データ メンバー||  
|unorm\_4::b データ メンバー||  
|unorm\_4::ba データ メンバー||  
|unorm\_4::bag データ メンバー||  
|unorm\_4::bagr データ メンバー||  
|unorm\_4::bar データ メンバー||  
|unorm\_4::barg データ メンバー||  
|unorm\_4::bg データ メンバー||  
|unorm\_4::bga データ メンバー||  
|unorm\_4::bgar データ メンバー||  
|unorm\_4::bgr データ メンバー||  
|unorm\_4::bgra データ メンバー||  
|unorm\_4::br データ メンバー||  
|unorm\_4::bra データ メンバー||  
|unorm\_4::brag データ メンバー||  
|unorm\_4::brg データ メンバー||  
|unorm\_4::brga データ メンバー||  
|unorm\_4::g データ メンバー||  
|unorm\_4::ga データ メンバー||  
|unorm\_4::gab データ メンバー||  
|unorm\_4::gabr データ メンバー||  
|unorm\_4::gar データ メンバー||  
|unorm\_4::garb データ メンバー||  
|unorm\_4::gb データ メンバー||  
|unorm\_4::gba データ メンバー||  
|unorm\_4::gbar データ メンバー||  
|unorm\_4::gbr データ メンバー||  
|unorm\_4::gbra データ メンバー||  
|unorm\_4::gr データ メンバー||  
|unorm\_4::gra データ メンバー||  
|unorm\_4::grab データ メンバー||  
|unorm\_4::grb データ メンバー||  
|unorm\_4::grba データ メンバー||  
|unorm\_4::r データ メンバー||  
|unorm\_4::ra データ メンバー||  
|unorm\_4::rab データ メンバー||  
|unorm\_4::rabg データ メンバー||  
|unorm\_4::rag データ メンバー||  
|unorm\_4::ragb データ メンバー||  
|unorm\_4::rb データ メンバー||  
|unorm\_4::rba データ メンバー||  
|unorm\_4::rbag データ メンバー||  
|unorm\_4::rbg データ メンバー||  
|unorm\_4::rbga データ メンバー||  
|unorm\_4::rg データ メンバー||  
|unorm\_4::rga データ メンバー||  
|unorm\_4::rgab データ メンバー||  
|unorm\_4::rgb データ メンバー||  
|unorm\_4::rgba データ メンバー||  
|unorm\_4::w データ メンバー||  
|unorm\_4::wx データ メンバー||  
|unorm\_4::wxy データ メンバー||  
|unorm\_4::wxyz データ メンバー||  
|unorm\_4::wxz データ メンバー||  
|unorm\_4::wxzy データ メンバー||  
|unorm\_4::wy データ メンバー||  
|unorm\_4::wyx データ メンバー||  
|unorm\_4::wyxz データ メンバー||  
|unorm\_4::wyz データ メンバー||  
|unorm\_4::wyzx データ メンバー||  
|unorm\_4::wz データ メンバー||  
|unorm\_4::wzx データ メンバー||  
|unorm\_4::wzxy データ メンバー||  
|unorm\_4::wzy データ メンバー||  
|unorm\_4::wzyx データ メンバー||  
|unorm\_4::x データ メンバー||  
|unorm\_4::xw データ メンバー||  
|unorm\_4::xwy データ メンバー||  
|unorm\_4::xwyz データ メンバー||  
|unorm\_4::xwz データ メンバー||  
|unorm\_4::xwzy データ メンバー||  
|unorm\_4::xy データ メンバー||  
|unorm\_4::xyw データ メンバー||  
|unorm\_4::xywz データ メンバー||  
|unorm\_4::xyz データ メンバー||  
|unorm\_4::xyzw データ メンバー||  
|unorm\_4::xz データ メンバー||  
|unorm\_4::xzw データ メンバー||  
|unorm\_4::xzwy データ メンバー||  
|unorm\_4::xzy データ メンバー||  
|unorm\_4::xzyw データ メンバー||  
|unorm\_4::y データ メンバー||  
|unorm\_4::yw データ メンバー||  
|unorm\_4::ywx データ メンバー||  
|unorm\_4::ywxz データ メンバー||  
|unorm\_4::ywz データ メンバー||  
|unorm\_4::ywzx データ メンバー||  
|unorm\_4::yx データ メンバー||  
|unorm\_4::yxw データ メンバー||  
|unorm\_4::yxwz データ メンバー||  
|unorm\_4::yxz データ メンバー||  
|unorm\_4::yxzw データ メンバー||  
|unorm\_4::yz データ メンバー||  
|unorm\_4::yzw データ メンバー||  
|unorm\_4::yzwx データ メンバー||  
|unorm\_4::yzx データ メンバー||  
|unorm\_4::yzxw データ メンバー||  
|unorm\_4::z データ メンバー||  
|unorm\_4::zw データ メンバー||  
|unorm\_4::zwx データ メンバー||  
|unorm\_4::zwxy データ メンバー||  
|unorm\_4::zwy データ メンバー||  
|unorm\_4::zwyx データ メンバー||  
|unorm\_4::zx データ メンバー||  
|unorm\_4::zxw データ メンバー||  
|unorm\_4::zxwy データ メンバー||  
|unorm\_4::zxy データ メンバー||  
|unorm\_4::zxyw データ メンバー||  
|unorm\_4::zy データ メンバー||  
|unorm\_4::zyw データ メンバー||  
|unorm\_4::zywx データ メンバー||  
|unorm\_4::zyx データ メンバー||  
|unorm\_4::zyxw データ メンバー||  
