---
title: "double_3 クラス | Microsoft Docs"
ms.custom: ""
ms.date: "11/04/2016"
ms.reviewer: ""
ms.suite: ""
...
|名前|説明|  
|--------|--------|  
|[double\_3::double\_3 コンストラクター](../Topic/double_3::double_3%20Constructor.md)|オーバーロードされます。  既定のコンストラクター。すべての要素を 0 で初期化します。|  
  
### パブリック メソッド  
  
|名前|説明|  
|--------|--------|  
|double\_3::get\_x メソッド||  
|double\_3::get\_xy メソッド||  
|double\_3::get\_xyz メソッド||  
|double\_3::get\_xz メソッド||  
|double\_3::get\_xzy メソッド||  
|double\_3::get\_y メソッド||  
|double\_3::get\_yx メソッド||  
|double\_3::get\_yxz メソッド||  
|double\_3::get\_yz メソッド||  
|double\_3::get\_yzx メソッド||  
|double\_3::get\_z メソッド||  
|double\_3::get\_zx メソッド||  
|double\_3::get\_zxy メソッド||  
|double\_3::get\_zy メソッド||  
|double\_3::get\_zyx メソッド||  
|double\_3::ref\_b メソッド||  
|double\_3::ref\_g メソッド||  
|double\_3::ref\_r メソッド||  
|double\_3::ref\_x メソッド||  
|double\_3::ref\_y メソッド||  
|double\_3::ref\_z メソッド||  
|double\_3::set\_x メソッド||  
|double\_3::set\_xy メソッド||  
|double\_3::set\_xyz メソッド||  
|double\_3::set\_xz メソッド||  
|double\_3::set\_xzy メソッド||  
|double\_3::set\_y メソッド||  
|double\_3::set\_yx メソッド||  
|double\_3::set\_yxz メソッド||  
|double\_3::set\_yz メソッド||  
|double\_3::set\_yzx メソッド||  
|double\_3::set\_z メソッド||  
|double\_3::set\_zx メソッド||  
|double\_3::set\_zxy メソッド||  
|double\_3::set\_zy メソッド||  
|double\_3::set\_zyx メソッド||  
  
### パブリック演算子  
  
|名前|説明|  
|--------|--------|  
|double\_3::operator\- 演算子||  
|double\_3::operator\-\- 演算子||  
|double\_3::operator\*\= 演算子||  
|double\_3::operator\/\= 演算子||  
|double\_3::operator\+\+ 演算子||  
...
|名前|説明|  
|--------|--------|  
|[double\_3::size 定数](../Topic/double_3::size%20Constant.md)||  
  
### パブリック データ メンバー  
  
|名前|説明|  
|--------|--------|  
|double\_3::b データ メンバー||  
|double\_3::bg データ メンバー||  
|double\_3::bgr データ メンバー||  
|double\_3::br データ メンバー||  
|double\_3::brg データ メンバー||  
|double\_3::g データ メンバー||  
|double\_3::gb データ メンバー||  
|double\_3::gbr データ メンバー||  
|double\_3::gr データ メンバー||  
|double\_3::grb データ メンバー||  
|double\_3::r データ メンバー||  
|double\_3::rb データ メンバー||  
|double\_3::rbg データ メンバー||  
|double\_3::rg データ メンバー||  
|double\_3::rgb データ メンバー||  
|double\_3::x データ メンバー||  
|double\_3::xy データ メンバー||  
|double\_3::xyz データ メンバー||  
|double\_3::xz データ メンバー||  
|double\_3::xzy データ メンバー||  
|double\_3::y データ メンバー||  
|double\_3::yx データ メンバー||  
|double\_3::yxz データ メンバー||  
|double\_3::yz データ メンバー||  
|double\_3::yzx データ メンバー||  
|double\_3::z データ メンバー||  
|double\_3::zx データ メンバー||  
|double\_3::zxy データ メンバー||  
|double\_3::zy データ メンバー||  
|double\_3::zyx データ メンバー||  
