...
|名前|説明|  
|--------|--------|  
|[uint\_3::uint\_3 コンストラクター](../Topic/uint_3::uint_3%20Constructor.md)|オーバーロードされます。  既定のコンストラクター。すべての要素を 0 で初期化します。|  
...
|--------|--------|  
|uint\_3::get\_x メソッド||  
|uint\_3::get\_xy メソッド||  
|uint\_3::get\_xyz メソッド||  
|uint\_3::get\_xz メソッド||  
|uint\_3::get\_xzy メソッド||  
|uint\_3::get\_y メソッド||  
|uint\_3::get\_yx メソッド||  
|uint\_3::get\_yxz メソッド||  
|uint\_3::get\_yz メソッド||  
|uint\_3::get\_yzx メソッド||  
|uint\_3::get\_z メソッド||  
|uint\_3::get\_zx メソッド||  
|uint\_3::get\_zxy メソッド||  
|uint\_3::get\_zy メソッド||  
|uint\_3::get\_zyx メソッド||  
|uint\_t::ref\_b メソッド||  
|uint\_t::ref\_g メソッド||  
|uint\_t::ref\_r メソッド||  
|uint\_t::ref\_x メソッド||  
...
|uint\_t::ref\_z メソッド||  
|uint\_3::set\_x メソッド||  
|uint\_3::set\_xy メソッド||  
|uint\_3::set\_xyz メソッド||  
|uint\_3::set\_xz メソッド||  
|uint\_3::set\_xzy メソッド||  
|uint\_3::set\_y メソッド||  
|uint\_3::set\_yx メソッド||  
|uint\_3::set\_yxz メソッド||  
|uint\_3::set\_yz メソッド||  
|uint\_3::set\_yzx メソッド||  
|uint\_3::set\_z メソッド||  
|uint\_3::set\_zx メソッド||  
|uint\_3::set\_zxy メソッド||  
|uint\_3::set\_zy メソッド||  
|uint\_3::set\_zyx メソッド||  
  
### パブリック演算子  
  
|名前|説明|  
|--------|--------|  
|uint\_3::operator\-\- 演算子||  
|uint\_3::operator%\= 演算子||  
|uint\_3::operator&\= 演算子||  
|uint\_3::operator\*\= 演算子||  
|uint\_3::operator\/\= 演算子||  
...
|名前|説明|  
|--------|--------|  
|[uint\_3::size 定数](../Topic/uint_3::size%20Constant.md)||  
...
|uint\_3::b データ メンバー||  
|uint\_3::bg データ メンバー||  
|uint\_3::bgr データ メンバー||  
|uint\_3::br データ メンバー||  
|uint\_3::brg データ メンバー||  
|uint\_3::g データ メンバー||  
|uint\_3::gb データ メンバー||  
|uint\_3::gbr データ メンバー||  
|uint\_3::gr データ メンバー||  
|uint\_3::grb データ メンバー||  
|uint\_3::r データ メンバー||  
|uint\_3::rb データ メンバー||  
|uint\_3::rbg データ メンバー||  
|uint\_3::rg データ メンバー||  
|uint\_3::rgb データ メンバー||  
|uint\_3::x データ メンバー||  
|uint\_3::xy データ メンバー||  
|uint\_3::xyz データ メンバー||  
|uint\_3::xz データ メンバー||  
|uint\_3::xzy データ メンバー||  
|uint\_3::y データ メンバー||  
|uint\_3::yx データ メンバー||  
|uint\_3::yxz データ メンバー||  
|uint\_3::yz データ メンバー||  
|uint\_3::yzx データ メンバー||  
|uint\_3::z データ メンバー||  
|uint\_3::zx データ メンバー||  
|uint\_3::zxy データ メンバー||  
|uint\_3::zy データ メンバー||  
|uint\_3::zyx データ メンバー||  
