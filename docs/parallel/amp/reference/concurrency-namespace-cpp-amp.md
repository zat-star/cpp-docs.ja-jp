...
|[direct3d_errorf](concurrency-namespace-functions-amp.md#direct3d_errorf)|書式指定文字列を Visual Studio**出力**ウィンドウおよびを発生させる、 [runtime_exception](runtime-exception-class.md)がある、同じ書式指定文字列します。|  
