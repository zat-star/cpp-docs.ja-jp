---
title: "縮小または拡大 (アイコン用イメージ エディター) のイメージの一部 |Microsoft ドキュメント"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
1.  サイズを変更するイメージの一部を選択します。 詳細については、次を参照してください。[イメージの領域を選択して](../windows/selecting-an-area-of-an-image-image-editor-for-icons.md)です。  
  
2.  選択範囲が必要なサイズになるまでは、サイズ変更ハンドルの 1 つをドラッグします。  
