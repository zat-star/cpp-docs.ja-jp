---
title: "オーバーライド指定子 (C++ コンポーネント拡張) |Microsoft ドキュメント"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
-   [オーバーライド指定子とネイティブ コンパイル](../dotnet/how-to-declare-override-specifiers-in-native-compilations-cpp-cli.md)  
 ...
 `abstract` と `sealed` は、オーバーライド指定子として機能しない型宣言でも有効です。  
  
 基底クラスの関数を明示的にオーバーライドする方法の詳細については、次を参照してください。[明示的なオーバーライド](../windows/explicit-overrides-cpp-component-extensions.md)です。  
