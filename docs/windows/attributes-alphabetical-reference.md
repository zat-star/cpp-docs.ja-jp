...
|[attribute](../windows/attribute.md)|カスタム属性を作成する。|  
...
|[コクラス](../windows/coclass.md)|COM インターフェイスを実装する COM オブジェクトを作成します。|  
...
|[helpstring](../windows/helpstring.md)|.hlp または .chm ファイルでヘルプ トピックの ID を指定します。|  
...
|[rdx](../windows/rdx.md)|レジストリ キーを作成または変更します。|  
...
|[requires\_category](../windows/requires-category.md)|クラスのために必要なコンポーネント カテゴリを指定します。|  
...
|[同期](../windows/synchronize.md)|は同期メソッドにアクセスします。|  
