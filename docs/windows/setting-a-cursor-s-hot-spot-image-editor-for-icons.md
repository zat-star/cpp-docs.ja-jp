---
title: "設定する、カーソル &#39; s ホット スポット (アイコン用イメージ エディター) |Microsoft ドキュメント"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
---
# <a name="setting-a-cursor39s-hot-spot-image-editor-for-icons"></a>設定する、カーソル &#39; s ホット スポット (アイコン用イメージ エディター)
...
1.  [イメージ エディター ツールバー](../windows/toolbar-image-editor-for-icons.md)をクリックして、**ホット スポットの設定**ツールです。  
  
2.  カーソルのホット スポットとして指定するピクセルをクリックします。  
  
     **ホット スポット**プロパティに、**プロパティ**新しい座標にウィンドウが表示されます。  
