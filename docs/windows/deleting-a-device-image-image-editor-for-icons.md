---
title: "デバイス イメージ (アイコン用イメージ エディター) の削除 |Microsoft ドキュメント"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
1.  アイコン イメージが表示されている間、**イメージ**エディターで、**デバイス イメージの削除**から、**イメージ**メニュー。 リソースの最後のアイコン イメージを削除すると、リソースも削除されます。  
  
    > [!NOTE]
    >  DEL キーを押すと、イメージとアイコンを描画した色が削除されますが、アイコンのままです。これが再設計できますようになりました。 誤って DEL キーを押して、アクションを元に戻すには、CTRL + Z を押します。  
