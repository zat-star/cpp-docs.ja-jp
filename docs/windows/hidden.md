 ...
 **隠し**C++ 属性と同じ機能を持つ、[隠し](http://msdn.microsoft.com/library/windows/desktop/aa366861)MIDL 属性。  
  
## <a name="example"></a>例  
 例を参照して[バインド可能な](../windows/bindable.md)の使用方法の例については**隠し**です。  
...
|||  
|-|-|  
|**対象**|`interface`、**クラス**、 `struct`、メソッド、プロパティ|  
|**反復可能**|×|  
