---
title: "方法: マニフェスト リソースを開く |Microsoft ドキュメント"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
1.  `Solution Explorer`でプロジェクトを開いて、 **リソース ファイル** のフォルダーを展開します。  
...
1.  ソリューション エクスプローラーで .manifest ファイルを右クリックし、ショートカット メニューの **[プログラムから開く]** をクリックします。  
