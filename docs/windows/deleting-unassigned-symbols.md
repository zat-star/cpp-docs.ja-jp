...
1.  [&#91;リソース シンボル&#93; ダイアログ ボックス](../windows/resource-symbols-dialog-box.md)で削除するシンボルを選択し、**\[削除\]** をクリックします。  
...
## 参照  
 [Changing Unassigned Symbols](../Topic/Changing%20Unassigned%20Symbols.md)   
