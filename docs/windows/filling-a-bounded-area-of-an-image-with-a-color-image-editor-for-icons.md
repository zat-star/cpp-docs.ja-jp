---
title: "色 (アイコン用イメージ エディター) でイメージの内側の塗りつぶし |Microsoft ドキュメント"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
1.  **イメージ エディター**ツールバー (または**イメージ**] メニューの [**ツール**コマンド)、をクリックして、**塗りつぶし**ツールです。  
  
2.  必要に応じて、描画色を選択: で、[カラー パレット](../windows/colors-window-image-editor-for-icons.md)前景の色を選択するマウスの左ボタンまたは背景色を選択するマウスの右ボタンをクリックします。  
  
3.  移動、 **Fill**ツールを格納する領域をします。  
  
4.  それぞれの前景色または背景色で塗りつぶすに左または右マウス ボタンをクリックします。  
