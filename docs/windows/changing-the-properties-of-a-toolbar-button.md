---
title: "ツール バー ボタンのプロパティの変更 |Microsoft ドキュメント"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
2.  新しい ID を入力、 **ID**プロパティに、[プロパティ ウィンドウ](/visualstudio/ide/reference/properties-window)、またはドロップダウン リストを使用して、新しい選択を**ID**です。  
