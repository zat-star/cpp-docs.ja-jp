...
### 別のディスプレイ デバイスのイメージを追加するには  
  
1.  \[イメージ\] メニューの \[新しいイメージの種類\] をクリックするか、または \[イメージ エディター\] ペインを右クリックし、ショートカット メニューの \[新しいイメージの種類\] をクリックします。  
  
2.  追加するイメージの種類を選択します。  \[カスタム\] をクリックすると、既定の一覧では選択できないサイズを指定してアイコンを作成できます。  
