...
複数の文字列の Caption プロパティを変更するには、次の操作を行います。  
  
### 複数の文字列の Caption プロパティを変更するには  
...
2.  **Ctrl** キーを押しながら目的の文字列をクリックして、変更する文字列を選択します。  
  
3.  [&#91;プロパティ&#93; ウィンドウ](../Topic/Properties%20Window.md)で、変更するプロパティの新しい値を入力します。  
