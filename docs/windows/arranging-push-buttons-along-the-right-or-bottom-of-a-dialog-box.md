---
title: "右端またはダイアログ ボックスの下部にあるプッシュ ボタンの配置 |Microsoft ドキュメント"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
2.  **形式**] メニューの [選択**ボタンの配置**、以下の配置の 1 つを選択。  
  
    -   **右**: プッシュ ボタン、ダイアログ ボックスの右端に揃えて配置します。  
  
    -   **下部にある**: プッシュ ボタン、ダイアログ ボックスの下端に揃えて配置します。  
  
         プッシュ ボタン以外のコントロールを選択すると、その位置の影響はありません。  
