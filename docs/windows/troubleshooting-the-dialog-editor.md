...
ダイアログ エディターでの作業中には、以下の点に注意する必要があります。  
  
-   [コントロールを追加してもダイアログ ボックスに表示されない](../mfc/adding-controls-to-a-dialog-causes-the-dialog-to-no-longer-function.md)  
  
-   [MFC でのリッチ エディット 1.0 コントロールの使用](../Topic/Using%20the%20RichEdit%201.0%20Control%20with%20MFC.md)  
