---
title: "WRL リファレンス |Microsoft ドキュメント"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
> [!NOTE]
>  Windows ランタイム C++ テンプレート ライブラリでは、Windows ランタイム C++ テンプレート ライブラリのインフラストラクチャをサポートし、コードから直接使用するものではありません機能を定義します。 このような機能は、このドキュメントに記録されます。  
