...
## <a name="remarks"></a>コメント  
 ...
 `CRecentDockSiteInfo` オブジェクトは、ペインが作成されるたびに作成されます。 各`CPane`オブジェクトにはメンバー変数、 [CPane::m_recentDockInfo](../../mfc/reference/cpane-class.md#m_recentdockinfo)にこの情報を格納します。  
