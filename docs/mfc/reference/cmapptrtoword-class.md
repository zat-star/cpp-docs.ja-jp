...
## <a name="remarks"></a>コメント  
 ...
 ときに、`CMapPtrToWord`オブジェクトを削除すると、またはその要素が削除された場合、ポインター、および単語が削除されます。 キーのポインターが参照されているエンティティは削除されません。  
  
 詳細については`CMapPtrToWord`、記事を参照して[コレクション](../../mfc/collections.md)です。  
