---
title: "MFC ウィザードとダイアログ ボックス |Microsoft ドキュメント"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
|[タイプ ライブラリからの MFC クラス](../../mfc/reference/adding-an-mfc-class-from-a-type-library.md)|クラスを生成し、指定したタイプ ライブラリに基づいて設定します。|  
|[MFC メッセージ ハンドラー](../../mfc/reference/adding-an-mfc-message-handler.md)|Windows メッセージのハンドラーを作成します。|  
|[MFC ODBC コンシューマーします。](../../mfc/reference/adding-an-mfc-odbc-consumer.md)|ODBC データベースと通信できるコンポーネントを作成します。|  
|[MFC プロジェクトに ATL サポート](../../mfc/reference/adding-atl-support-to-your-mfc-project.md)|ヘッダーとアクティブ テンプレート ライブラリ (ATL) で必要なマクロを作成します。|  
