...
### <a name="parameters"></a>パラメーター  
 `dwOption`  
 インターネット オプションを設定します。 参照してください[オプション フラグ](http://msdn.microsoft.com/library/windows/desktop/aa385328)Windows SDKfor 可能なオプションの一覧にします。  
