---
title: "コントロールの作成方法と |Microsoft ドキュメント"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
-   [コントロールを手動で追加する](../mfc/adding-controls-by-hand.md)(せずにダイアログ エディター)  
...
-   [コモン コントロールから通知を受信](../mfc/receiving-notification-from-common-controls.md)  
...
-   個々 の制御: を参照してください[コントロール](../mfc/controls-mfc.md)すべてコモン コントロールへのリンク  
