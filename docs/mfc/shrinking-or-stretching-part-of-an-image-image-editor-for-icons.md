...
1.  イメージの中のサイズ変更する部分を選択します。  詳細については、「[イメージの領域の選択](../mfc/selecting-an-area-of-an-image-image-editor-for-icons.md)」を参照してください。  
  
2.  選択領域が目的のサイズになるまで、サイズ変更ハンドルの 1 つをドラッグします。  
