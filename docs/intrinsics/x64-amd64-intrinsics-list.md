...
|[_mm_i32gather_epi32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_i32gather_epi32)|AVX2 [2]|immintrin.h|_ _m128i _mm_i32gather_epi32 (const int * ベース、\__m128i キーワード、const int 型の小数点以下桁数)|
...
|[_mm_i32gather_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_i32gather_ps)|AVX2 [2]|immintrin.h|_ _m128 _mm_i32gather_ps (float、const * ベース、\__m128i キーワード、const int 型の小数点以下桁数)|
|[_mm_i64gather_epi32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_i64gather_epi32)|AVX2 [2]|immintrin.h|_ _m128i _mm_i64gather_epi32 (const int * ベース、\__m128i キーワード、const int 型の小数点以下桁数)|
|[_mm_i64gather_epi64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_i64gather_epi64)|AVX2 [2]|immintrin.h|_ _m128i _mm_i64gather_epi64 (\__int64 const *、基本\__m128i キーワード、const int 型の小数点以下桁数)|
...
|[_mm_i64gather_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_i64gather_ps)|AVX2 [2]|immintrin.h|_ _m128 _mm_i64gather_ps (float、const * ベース、\__m128i キーワード、const int 型の小数点以下桁数)|
...
|[_mm_mask_i32gather_epi32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_mask_i32gather_epi32)|AVX2 [2]|immintrin.h|_ _m128i _mm_mask_i32gather_epi32 (\__m128i src、const int * 基本、\__m128i インデックス\__m128i マスク、const int 型の小数点以下桁数)|
|[_mm_mask_i32gather_epi64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_mask_i32gather_epi64)|AVX2 [2]|immintrin.h|_ _m128i _mm_mask_i32gather_epi64 (\__m128i src\__int64 const *、基本\__m128i インデックス\__m128i マスク、const int 型の小数点以下桁数)|
...
|[_mm_mask_i32gather_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_mask_i32gather_ps)|AVX2 [2]|immintrin.h|_ _m128 _mm_mask_i32gather_ps (\__m128 src、float 型の const *、基本\__m128i インデックス\__m128 マスク、const int 型の小数点以下桁数)|
|[_mm_mask_i64gather_epi32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_mask_i64gather_epi32)|AVX2 [2]|immintrin.h|_ _m128i _mm_mask_i64gather_epi32 (\__m128i src、const int * 基本、\__m128i インデックス\__m128i マスク、const int 型の小数点以下桁数)|
|[_mm_mask_i64gather_epi64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_mask_i64gather_epi64)|AVX2 [2]|immintrin.h|_ _m128i _mm_mask_i64gather_epi64 (\__m128i src\__int64 const *、基本\__m128i インデックス\__m128i マスク、const int 型の小数点以下桁数)|
...
|[_mm_mask_i64gather_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_mask_i64gather_ps)|AVX2 [2]|immintrin.h|_ _m128 _mm_mask_i64gather_ps (\__m128 src、float 型の const *、基本\__m128i インデックス\__m128 マスク、const int 型の小数点以下桁数)|
...
|[_mm_maskstore_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_maskstore_ps)|AVX [2]|immintrin.h|_mm_maskstore_ps を無効にする (float *、\__m128i、\__m128)|
...
|[_mm_store_ss](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_store_ss)|SSE|intrin.h|_mm_store_ss を無効にする (float *\__m128)|
...
|[_mm256_extracti128_si256](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_extracti128_si256)|AVX2 [2]|immintrin.h|_ _m128i _mm256_extracti128_si256 (\__m256i, int offset)|
...
|[_mm256_i32gather_epi32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_i32gather_epi32)|AVX2 [2]|immintrin.h|__m256i _mm256_i32gather_epi32 (const int * ベース、\__m256i インデックス、const int 型の小数点以下桁数)|
...
|[_mm256_i32gather_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_i32gather_ps)|AVX2 [2]|immintrin.h|__m256 _mm256_i32gather_ps (float、const * ベース、\__m256i インデックス、const int 型の小数点以下桁数)|
|[_mm256_i64gather_epi32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_i64gather_epi32)|AVX2 [2]|immintrin.h|__m256i _mm256_i64gather_epi32 (const int * ベース、\__m256i インデックス、const int 型の小数点以下桁数)|
...
|[_mm256_i64gather_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_i64gather_ps)|AVX2 [2]|immintrin.h|_ _m128 _mm256_i64gather_ps (float、const * ベース、\__m256i インデックス、const int 型の小数点以下桁数)|
...
|[_mm256_mask_i32gather_epi32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_mask_i32gather_epi32)|AVX2 [2]|immintrin.h|__m256i _mm256_mask_i32gather_epi32 (\__m256i src、const int * 基本、\__m256i インデックス\__m256i マスク、const int 型の小数点以下桁数)|
...
|[_mm256_mask_i64gather_epi32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_mask_i64gather_epi32)|AVX2 [2]|immintrin.h|_ _m128i _mm256_mask_i64gather_epi32 (\__m128i src、const int * 基本、\__m256i インデックス\__m128i マスク、const int 型の小数点以下桁数)|
...
|[_mm256_maskstore_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_maskstore_ps)|AVX [2]|immintrin.h|_mm256_maskstore_ps を無効にする (float *、\__m256i、\__m256)|
...
|[_rdrand64_step](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_rdrand64_step)|RDRAND [2]|immintrin.h|int _rdrand64_step (符号なし\__int64 *)|
...
|_store_be_u64<br /><br /> [_storebe_i64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_storebe_i64&expand=5143)|MOVBE|immintrin.h|void _store_be_u64(void *, unsigned \__int64);<br /><br /> void _storebe_i64 (void \*、 \__int64) です。[3]|
