...
```  
 ...
 識別子の有効期間と可視性については、「[有効期間、スコープ、可視性、およびリンケージ](../Topic/Lifetime,%20Scope,%20Visibility,%20and%20Linkage.md)」で説明します。  関数の詳細については、「[関数](../Topic/Functions%20\(C\).md)」を参照してください。  
