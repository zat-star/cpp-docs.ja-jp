...
## [デバッグと例外のクラス](debugging-and-exceptions-classes.md)
## [デュアル インターフェイス クラス](dual-interfaces-classes.md)
## [列挙子とコレクションのクラス](enumerators-and-collections-classes.md)
...
## [オブジェクト安全性クラス](object-safety-classes.md)
## [永続化クラス](persistence-classes.md)
## [プロパティとプロパティ ページのクラス](properties-and-property-pages-classes.md)
## [レジストリ サポート クラス](registry-support-classes.md)
## [実行中オブジェクト クラス](running-objects-classes.md)
